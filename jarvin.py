...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        ...
        speak("Good Evening!")
        print("Good Evening!")
    speak("Hello Sir, I am David A global peace-keeping initiative designed by PBL Group 5 of Automation and Robotics Department of D.Y. Patil Institute of Technology,Pune.Please tell me How can I help you")
    print("Hello Sir, I am David A global peace-keeping initiative designed by PBL Group 5 of Automation and Robotics Department of D.Y. Patil Institute of Technology,Pune.Please tell me How can I help you")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('aks.amansingh21@gmail.com', 'Aman@2112')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'play song on youtube' in query:
            ...
            music_dir = 'C:\\Users\\A\\Desktop\\Python Virtual Assistant Project\\songs'
